...
import {defaultStyles, useAjv, useControlAppliedOptions, useStyles, useTranslator} from './composition';
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const toAdditionalPropertyType = (        propName: string,        propValue: any    ): AdditionalPropertyType => {
      ...
      if (
        ...
        const matchedPattern = Object.keys(  control.value.schema.patternProperties  )
  ...
  methods: {
    ...
    addProperty() {
      if (this.newPropertyName) {
        const additionalProperty = this.toAdditionalPropertyType(this.newPropertyName, undefined        );
        ...
        if (this.control.data && typeof this.control.data === 'object' && additionalProperty.schema   ) {
