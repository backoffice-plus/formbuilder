...
export const layoutCategorization = {schema:schema,uischema:uischema,data: {}};
export const layoutCategorizationSimplified = {schema:schema,uischema:uischemaSimplified,data: {}};
